...
\begin{abstract}
  ...
  counterparts, by running a comprehensive suite of NUMBER unit tests.

  We show that Futhark can be compiled to \csharp{} GPU code, resulting in
  comparable performance with the C- and Python OpenCL backends ($\pm 1\%$),
  ...
  context, where they are shown to perform comparably with benchmarks written in
  Futhark.
\end{abstract}
