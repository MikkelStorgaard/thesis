...
\section{Using the \fshark{} compiler and wrapper}
...
The actual return type is always the same as the
return type declared in the source \fshark{} file.
and in figure \ref{fig:fsharkusageexample1} shows us how to compile and use the
compiled GPU kernel in our program. Let us go through the lines in figure
\ref{fig:fsharkusageexample1} step by step.
