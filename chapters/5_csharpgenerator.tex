...
\item[Step 1:]\hfill\\
  ...
  The \texttt{ImpCode} grammar is available in the Futhark repository\footnote{\url{https://github.com/diku-dk/futhark/blob/master/src/Futhark/CodeGen/ImpCode.hs}}. The \texttt{ImpCode}
...
In \csharp{}, arrays and lists are accessed by indexing, for example \texttt{var
  x = myArray[10];}.
These arrays are managed by .NET's CLR\cite{CLR}, and
