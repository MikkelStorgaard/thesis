...
shown in figure \ref{fig:futharkentrypairexe}

\begin{figure}[H]
  \centering
\begin{minted}{csharp}
    (long, byte[], int) futhark_main(long xs_mem_sizze_3357, byte[] xs_mem_3358,
                                     int sizze_3348)
    {
        var out_memsizze_3367 = new long();
        var out_mem_3366 = allocateMem(0);
        var out_arrsizze_3368 = new int();
        long binop_x_3360;
        binop_x_3360 = sext_i32_i64(sizze_3348);
        long bytes_3359;
        bytes_3359 = (binop_x_3360 * Convert.ToInt64(4));
        byte[] mem_3361;
        mem_3361 = allocateMem(bytes_3359);
        var i_3355 = Convert.ToInt32(0);
        var one_3371 = Convert.ToInt32(1);
        for (int counter_3370 = 0 ;counter_3370 < sizze_3348 ;counter_3370++)
        {
            int x_3351;
            x_3351 = indexArray<int>(xs_mem_3358, (i_3355 * Convert.ToInt32(4)),
                                     BitConverter.ToInt32);
            int res_3352;
            res_3352 = (x_3351 + Convert.ToInt32(2));
            writeScalarArray(mem_3361, (i_3355 * Convert.ToInt32(4)),
                             Convert.ToInt32(res_3352));
            i_3355 += one_3371;
        }
        out_arrsizze_3368 = sizze_3348;
        out_memsizze_3367 = bytes_3359;
        out_mem_3366 = mem_3361;
        return (out_memsizze_3367, out_mem_3366, out_arrsizze_3368);
    }
    void entry_main()
    {
        var (int_array, lengths) = ReadStrArray<int>(1, "i32");
        var int_array_length = lengths[0];
        var byte_array = convertToByteArray<int>(int_array);
        var byte_array_length = byte_array.Length;

        var (res_array_memsize, size, res_array, )
        var xs_mem_3358 = unwrapArray(xs_mem_3358_ext.Item1, sizeof(int));
        byte[] xs_mem_copy_3372;
        var xs_mem_3358_nbytes = xs_mem_3358.Length;
        var out_memsizze_3367 = new long();
        var out_mem_3366 = allocateMem(0);
        var out_arrsizze_3368 = new int();
\end{minted}
  
  \caption{An Futhark/entry function pair from the mapPlus2 executable}
