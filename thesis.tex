...
\setminted{fontsize=\small,baselinestretch=1,frame=lines,framerule=1pt}
\lstset{fontsize=\small,frame=lines}
...
\subtitle{prut PRUT prut}
\date{Handed in: \today{}}
\advisor{Advisor: Cosmin eller Troels}
\frontpageimage{logo.png}
...
\include{chapters/8_method}
\include{chapters/9_related_work}
\include{chapters/11_conclusion}
\include{chapters/a_appendices}
\include{chapters/a_fshark_arrays}
\include{chapters/b_interoperability_design}
\end{document}
